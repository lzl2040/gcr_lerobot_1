...
OXE_NAMED_MIXTURES: Dict[str, List[Tuple[str, float]]] = {
    ...
    "libero_10_no_noops": [
     ...
     "pizza_v9_task_5_v0":[
         ("pizza_v9_task_5_v0", 1.0), 
     ],
     "pizza_v9_task_9_v0":[
         ("pizza_v9_task_9_v0", 1.0), 
     ],
     "pizza_v9_task_20_v0":[
         ("pizza_v9_task_20_v0", 1.0), 
     ],
     "pizza_v9_task_9_sep1":[
         ("pizza_v9_task_9_sep1", 1.0), 
     ],
     "pizza_v9_task_9_sep2":[
         ("pizza_v9_task_9_sep2_r2", 1.0), 
     ],
     "pizza_v9_task_5_sep2":[
         ("pizza_v9_task_5_sep2", 1.0), 
     ],
     "pizza_v9_task_16_sep1":[
         ("pizza_v9_task_16_sep1", 1.0), 
     ],
     "pizza_v9_task_16_sep2":[
         ("pizza_v9_task_16_sep2", 1.0), 
     ],
     "pizza_v9_task_3_sep1":[
         ("pizza_v9_task_3_sep1", 1.0), 
     ],
     "pizza_v9_task_19_sep1":[
         ("pizza_v9_task_19_sep1", 1.0), 
     ],
     "pizza_long_sub1_hz_2.5":[
            ("pizza_long_sub1_hz_2.5", 1.0),
     ],
    "pizza_long_sub1_hz_4":[
        ("pizza_long_sub1_hz_4", 1.0),
    ],
     "pizza_long_sub3_hz_2.5":[
            ("pizza_long_sub3_hz_2.5", 1.0),
     ],
     "pizza_long_sub3_hz_4":[
        ("pizza_long_sub3_hz_4", 1.0),
    ],
     "pizza_long_sub4_hz_2.5":[
            ("pizza_long_sub4_hz_2.5", 1.0),
     ],
     
     "pizza_long_sub1_hz_15":[
            ("pizza_long_sub1_hz_15", 1.0),
     ],
     "pizza_long_sub2_hz_15":[
            ("pizza_long_sub2_hz_15", 1.0),
     ],
     "pizza_long_sub3_hz_15":[
            ("pizza_long_sub3_hz_15", 1.0),
     ],
     "pizza_long_full_hz_2.5":[
            ("pizza_long_full_hz_2.5", 1.0),
     ],
     "american_data": [
         ("american_data", 1.0),
     ],
     "american_data_filter": [
         ("american_data_filter", 1.0),
     ],
     "aloha_table": [
         ("aloha_table", 1.0),
     ],
     ...
     "simpler_fractal_sub1":[
         ("simpler_fractal_sub1", 1.0), 
     ],
     "simpler_fractal_sub2":[
         ("simpler_fractal_sub2", 1.0), 
     ],
     "cup_fs_50":[
         ("cup_fewshot_50", 1.0),
     ],
    ...
    "block_fs_50":[
     ...
     "pizza_long_sub2_hz_4":[
              ("pizza_long_sub2_hz_4", 1.0),
          ],
     "pizza_long_sub4_hz_4":[
         ("pizza_long_sub4_hz_4", 1.0),
     ],
     "pizza_long_sub4_hz_4_ua":[
         ("pizza_long_sub4_hz_4_ua", 1.0),
     ],
     "pizza_sub1_fs_10":[
         ("pizza_sub1_fewshot_10", 1.0),
     ],
     "pizza_sub1_fs_50":[
         ("pizza_sub1_fewshot_50", 1.0),
     ],
     "pizza_sub1":[
         ("pizza_sub1", 1.0),
     ],
